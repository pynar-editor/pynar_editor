...
class EnterDialog(QDialog):
    ...
    def accept(self):
        if self.fileDir:
            ...
            try:
                ...
                q = MessageBox(QMessageBox.Critical, 'Hata', 'Yol yeniden adlandırılamadı\n\n' + str(e),
        ...
        if not self.fileDir:
            ...
            for file in os.listdir(path):
                if file == newName:
                    result = MessageBox(QMessageBox.Question, 'Uyarı', 'Dosya zaten mevcut\n' +
            ...
            try:
                ...
                q = MessageBox(QMessageBox.Critical, 'Hata', 'Dosya yeniden adlandırılamadı\n\n' + str(e),
                                QMessageBox.NoButton)
    ...
    def acceptMakeFolder(self):
        ...
        try:
            ...
            q = MessageBox(QMessageBox.Critical, 'Hata', 'Dizin oluşturulamadı\n\n' + str(e),
                                QMessageBox.NoButton)
