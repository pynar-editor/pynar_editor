...
class FindReplaceDialog(QDialog):
    ...
    def messageBoxShow(self,i,find_text,replace_text):
        ...
        messageBox.setWindowTitle("Bilgilendirme")
        messageBox.setWindowIcon(QIcon(':/icon/images/headerLogo1.png'))
        messageBox.setIcon(QMessageBox.Information)
        if i > 0:
            messageBox.setText("""{} Adet "{}" İfadesi "{}" ile Değiştirildi.""".format(i,find_text,replace_text))
        else:
            messageBox.setText("Değiştirilecek kelime bulunamadı.")
        messageBox.exec_()
